...
public class IPUtils {
    ...
    public static void main(String[] args) {
        Area area = IPUtils.getArea("124.114.11.220");
        System.out.println(area);
        String format1 = AreaUtils.format(area.getId());
        System.out.println(format1);


        Integer areaId = IPUtils.getAreaId("2.56.8.0");
        System.out.println(areaId);

        String format = AreaUtils.format(areaId);
