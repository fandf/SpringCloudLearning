package com.fdf.sso.controller;
...
public class ApiController {
    @Value("${fdf.sso.client-id:}")
    private String clientId;

    @Value("${fdf.sso.client-secret:}")
    private String clientSecret;

    @Value("${fdf.sso.redirect-uri:}")
    private String redirectUri;

    @Value("${fdf.sso.access-token-uri:}")
    private String accessTokenUri;

    @Value("${fdf.sso.user-info-uri:}")
    ...
    private List<String> getRoles(Map userMap) {
        ...
        if (CollectionUtil.isNotEmpty(roles)) {
            roles.forEach(e -> result.add(e.get("code")));
        }
        return result;
    }
